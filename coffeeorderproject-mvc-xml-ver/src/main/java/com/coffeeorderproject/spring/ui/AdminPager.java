package com.coffeeorderproject.spring.ui;

public class AdminPager { // 페이징
	...
	public AdminPager(int pageNum, int total) {
		this.pageNum = pageNum;
		this.total = total;
		
		int pagerBlock = (pageNum - 1) / 4;
		int start = (pagerBlock * 4) + 1;
		int end = 0;
		
		this.lastPage = this.total / 10 + (this.total % 10 < 10 && this.total % 10 != 0 ? 1 : 0);
