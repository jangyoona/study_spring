...
<body>
	...
	<div class="container-fluid page-header py-5">
		<h1 class="text-center text-white display-6">1:1문의 글 수정하기</h1>
	...
	<div class="container-fluid py-5">
		<div class="container py-5">
			<div class="table-responsive">
				<form action="inquiry1on1edit" method="post"
	...
	$(function() {
		...
		location.href = 'inquiry1on1detail?pageNo=${ pageNo }&boardno=${ board.boardNo }';
		});
