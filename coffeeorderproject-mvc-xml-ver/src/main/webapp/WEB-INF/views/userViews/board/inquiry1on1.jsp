		...
		<div class="container py-5">
			<div class="table-responsive">
				<table class="table">
						...
						<c:forEach var="board" items="${boardList}">
							...
							<c:if test="${loginUser != null }">
								<tr>
									...
									<td><c:choose>
											<c:when
												test="${loginUser.userId == board.userId || loginUser.userAdmin}">
												<a href="inquiry1on1detail?boardno=${board.boardNo}">
													${board.boardTitle} </a>
											</c:when>
											<c:otherwise>
					...
					<!-- pageList -->
					<tr>
						<td colspan="4"  style="text-align: center;"><br> <br> ${ pager }
							<br> <br></td>
					</tr>
					<!-- //// -->
				</table>
		...
		$(function() {
			...
			$('#user-write-top-btn').on('click', function(event) {
				...
				if(${ loginUser == null } ){
					...
					location.href = 'inquiry1on1write';
				}
			});
