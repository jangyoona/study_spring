...
<body>
	...
	<div class="container-fluid page-header py-5">
		...
		<h2 class="text-center text-white display-5">${ prodName.prodName }</h2>
		<h2 class="text-center text-white display-7">"${ prodName.prodExplain }"</h2>
		...
		<div class="container py-5">
			<div class="table-responsive">
				...
				<table class="table">
					<thead>
						<!-- <tr>
							<th colspan="5" style="text-align: right;">
								<button id="user-write-top-btn"
									class="btn border-secondary rounded-pill px-2 py-1 text-primary"
									type="button">새로운 글 작성하기</button>
							</th>
						<tr> -->
						<tr>
							<th colspan="5"><h6 align="center">리뷰작성은 마이페이지 주문목록에서
									작성 가능합니다.</h6></th>
						</tr>
						<tr>
					...
					<tbody>
						<c:forEach var="board" items="${prodNoList}">
							<c:if test="${not board.boardDelete}">
								<tr>
									...
									<td><a
										href="detail?boardno=${board.boardNo}&pageNo=${pageNo}&prodno=${board.prodNo}">
