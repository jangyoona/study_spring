...
<body>
	...
	<div class="container-fluid page-header py-5">
		<h1 class="text-center text-white display-6">리뷰 수정하기</h1>
		<ol class="breadcrumb justify-content-center mb-0">
			<li class="breadcrumb-item"><a href="/coffeeorderproject/home">Home</a></li>
			<li class="breadcrumb-item active text-white">ReviewBoardEdit</li>
		</ol>
	</div>
						...
						<thead>
							<tr>
								<!-- <th><div style="width: 580px;">
										작성자 <input type="text" name="userid" style="width: 580px;" />
									</div></th> -->
								<td><input type="hidden" name="userId"
									value="${ loginUser.userId }"> 작성자:${ board.userId }</td>
							</tr>
						</thead>
						<tbody>
							<tr>
								<th><div style="width: 580px;">
										제목 <input value="${ board.boardTitle }" type="text"
											name="boardtitle" style="width: 580px;" />
									</div></th>
							</tr>
							<tr>
								<td style="height: 30px">첨부파일
									<c:forEach var="attach" items="${ board.attachments }">
		                			${ attach.userfilename } 
		                			[<a href='delete-attach?attachno=${ attach.fileNo }&boardno=${ board.boardNo }'>삭제</a>]<br>
									</c:forEach> <input type="file" name="attach"
							...
							<tr>
								<td><textarea name="boardcontent" style="width: 580px"
										rows="15">${ board.boardContent }</textarea></td>
							</tr>
							<tr>
								<td colspan="5"><input
									class="btn border-secondary rounded-pill px-2 py-1 text-primary"
									type="submit" value="글 수정하기" /> <input
									<%-- 가독성 구분선 --%>
									class="btn border-secondary rounded-pill px-2 py-1 text-primary"
									id="tolist_button" type="button" value="작성 취소" /></td>
							</tr>
						</tbody>
					</table>
				</form>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			location.href = 'detail?pageNo=${ pageNo }&boardno=${ board.boardNo }';
			});
